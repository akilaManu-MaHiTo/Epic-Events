...
<head>
		...
		<link rel="stylesheet" type="text/css" href="styles/editService.css">
		<meta charset="ISO-8859-1">
		<link rel="preconnect" href="https://fonts.googleapis.com">
		<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
		<link href="https://fonts.googleapis.com/css2?family=Lexend&display=swap" rel="stylesheet">

<link rel="stylesheet" type="text/css" href="styles/editVenue.css">
<meta charset="ISO-8859-1">
    	...
    	<div class="container">
	    	<div class="box">
			  <form action="AddVenueServlet" method="post">
			    <label for="title">
			      <h3><b><br>Venue Information Form</b></h3>
			    </label>
			    <label for="venue_name"><b>Venue Name </b></label>
			    <input type="text" id="username" name="venue_name" placeholder="Enter the venue name" required></input>
				
				<label for="address"><b>Address </b></label>
			    <input type="text" class="address" id="username" name="address" placeholder="Enter the address" required></input>	
				
				<label for="capacity"><b>Capacity</b></label>
			    <input type="number" id="username" name="capacity" placeholder="Enter the capacity" required></input>		
				
			    <label for="price"><b>Price<b></label>
			    <input type="text" id="password" name="price" step="0.01" placeholder="Enter the price" required pattern="\d+(\.\d{2})?" title="Please enter a valid Price" required></input>
			
			    <br>
			    <input type="submit" value="Add Venue" id="submitBtn"></input>
			  </form>
			  <a href="updateVenue.jsp" class="submit_a">
			    <input type="button" value="Update Venue" id="submitBtn"></input>
			    </a>
			</div>
