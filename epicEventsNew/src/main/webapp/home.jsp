...
<body>
   ...
   <div class="position"> 
    ...
    <div>
    	...
    	<div class="gtext">
			<span>Your hard work has paid off, and now it's time to celebrate! Whether you're graduating 
...
<div class="event-list">
    <% 
        ...
        try {
            ...
            while(resultSet.next()) {
                ...
                out.println("<button class=\"custom-btn event-link\" onclick=\"window.location.href='" + "loader.jsp" + "'\">Book Now</button>");
    ...
    <footer class="footer">
		...
		<div class="overlay1">
		    <div class="popup1">
		        <div class="close-btn1"><img src="img/login/close.png" class="close-btn"></div>
		        <div class="form1">
		            <h2>Login</h2>
		            <form action="<%= request.getContextPath() %>/LoginServlet" method="post">
		                <div class="form-Element1">
		                    <label for="email">Email</label>
		                    <input type="email" required id="email" placeholder="Enter Your Email" name="email" class="in">
		                </div>
		                <div class="form-Element1">
		                    <label for="password">Password</label>
		                    <input type="password" required id="password" placeholder="Enter Your Password" name="pass" class="in">
		                </div>
